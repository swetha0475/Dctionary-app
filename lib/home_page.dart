...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(child: Scaffold(body: Padding(padding:const EdgeInsets.all(16.0),
  ...
  _buildMeaningWidget(Meanings meanings){
    ...
    padding: const EdgeInsets.all(10.0),
     ...
     _buildSet("Synonyms",meanings.antonyms),
       ],
      ),
     ),
    );
  ...
  _noDataWidget(){
    return SizedBox(
      height: 100,
      child: Center(child: Text("No Data",style: const TextStyle(fontSize: 20),
      ),
      ),
    );
